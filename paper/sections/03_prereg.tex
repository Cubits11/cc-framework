...
\paragraph{Decision rule (stability evidence).}
...
$\alpha_{\mathrm{strata}}$ (and thus report finite-sample evidence for
strata stability) if
\begin{equation}
...
The rule~\eqref{eq:H3-decision} is conservative: failure to meet this
stability rule does not prove the existence of a Simpson reversal, only
...
non-acceptance over overconfident claims of homogeneity across
strata.
\end{remark}

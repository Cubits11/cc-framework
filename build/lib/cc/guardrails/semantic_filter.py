...
class SemanticFilter(Guardrail):
    ...
    def __init__(
        ...
        default_params = {"max_features": 5000, "ngram_range": (1, 3), "stop_words": "english"}
    ...
    def calibrate(self, benign_texts: list, target_fpr: float = 0.05) -> None:
        ...
        print(
            f"SemanticFilter calibrated: threshold={self.similarity_threshold:.3f}, FPR={actual_fpr:.3f}"
        )

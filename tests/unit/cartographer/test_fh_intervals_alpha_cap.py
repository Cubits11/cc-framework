...
def test_fh_intervals_policy_binds_exact():
    ...
    assert (pytest.approx(0.37), pytest.approx(0.65)) == I1
    assert (pytest.approx(0.05), pytest.approx(0.05)) == I0  # U0==alpha
    # variance envelopes
...
def test_fh_intervals_relaxed_no_cap():
    ...
    assert (pytest.approx(0.15), pytest.approx(0.55)) == I1
    assert (pytest.approx(0.03), pytest.approx(0.05)) == I0

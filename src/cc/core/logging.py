        ...
        for i, line in enumerate(lines):
            try:
                ...
                if record["prev_hash"] != expected_prev:
                    return False, f"Hash chain broken at record {i+1}: expected prev_hash {expected_prev}, got {record['prev_hash']}"
                ...
                if stored_hash != computed_hash:
                    return False, f"Hash mismatch at record {i+1}: stored {stored_hash}, computed {computed_hash}"
